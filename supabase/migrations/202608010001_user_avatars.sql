-- Public profile pictures with authenticated, owner-only writes.
...
drop policy if exists storage_avatar_delete on storage.objects;

create policy storage_avatar_select
